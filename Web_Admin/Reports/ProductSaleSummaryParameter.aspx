<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="ProductSaleSummaryParameter.aspx.cs" Inherits="Reports_ProductSaleSummaryParameter" Title="รายงานสรุปรายการสินค้าที่ขาย" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="500px" class="searchTable">
                        ...
                        <tr height="25px">
                            ...
                            <td width="90px">
                                ชื่อลูกค้า</td>  
                            <td colspan="3">
                                <asp:TextBox id="txtCustomer" runat="server" CssClass="zTextbox" Width="349px"></asp:TextBox></td> 
                            <td>
                            </td>  
                        </tr>
                         <tr height="25px"  id = "trCustomer" runat="server">
                            ...
                            <td width="90px">
                                ชื่อลูกค้า</td>  
                            <td colspan="3">
                                <asp:DropDownList ID="cmbCustomer" runat="server" CssClass="zCombobox" Width="356px" AutoPostBack="True">
                                </asp:DropDownList></td> 
                            <td>
                            </td>  
                        </tr>
