<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="Division.aspx.cs" Inherits="Master_Division" Title="ข้อมูลฝ่าย" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="750px">
                    ...
                    <tr height="25px">
                        ...
                        <td width="150px">
                            ชื่อย่อ</td> 
                        <td>
                            <asp:TextBox ID="txtAbbName" runat="server" CssClass="zTextbox" MaxLength="50" Width="205px"></asp:TextBox>
                     ...
                     <tr height="25px">
                        ...
                        <td width="150px">
                            ชื่อส่วนงาน</td> 
                        <td>
                            <asp:DropDownList ID="cmbDepartment" runat="server" Width="212px">
                            </asp:DropDownList>
