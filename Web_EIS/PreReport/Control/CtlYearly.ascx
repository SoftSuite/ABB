<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CtlYearly.ascx.cs" Inherits="PreReport_Control_CtlYearly" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="550px" class="searchTable">
                        ...
                        <tr height="25px">
                            ...
                            <td style="height: 25px">
                                ...
                                </asp:DropDownList><asp:Label ID="label1" runat="server" ForeColor="red">*</asp:Label></td>  
                        </tr>
                        <tr height="25px">
                            <td style="width:10px" >
                            </td> 
                        ...
                        <tr height="25px">
                            ...
                            <td>
                                ...
                                </asp:DropDownList><asp:Label ID="label2" runat="server" ForeColor="red">*</asp:Label></td>   
                        </tr>
                        <tr height="25px">
                            <td style="width:10px" >
                            </td> 
