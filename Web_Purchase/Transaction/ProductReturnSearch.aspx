<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="ProductReturnSearch.aspx.cs" Inherits="Transaction_ProductReturnSearch" Title="ใบส่งคืนสินค้า/วัตถุดิบ" %>
            ...
            <td>
                <asp:GridView ID="grvPDReturn" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField SortExpression="PDRETURNDATE" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="False" HeaderText = "วันที่" DataField="PDRETURNDATE" >
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="LOID" DataNavigateUrlFormatString="ProductReturn.aspx?loid={0}"
                            DataTextField="STCODE" HeaderText="เลขที่ใบแจ้งคืน" DataTextFormatString="{0}" >
                            <ItemStyle Width="110px" HorizontalAlign="center"/>
                            <HeaderStyle Width="110px" /> 
                        </asp:HyperLinkField>                  
