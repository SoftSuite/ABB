<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupProductSearch.aspx.cs" Inherits="Search_PopupProductSearch" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="540px" class="searchTable">
                        ...
                        <tr height="25px">
                            ...
                            <td width="90px">
                                รหัสสินค้า</td>  
                            <td colspan="3">
                                <asp:TextBox ID="txtBarcode" runat="server" CssClass="zTextbox" Width="150px"></asp:TextBox></td> 
                            <td></td>  
                        </tr>
                        <tr height="25px">
                            <td width="10px">
                    ...
                    <asp:GridView ID="grvProduct" runat="server" Width="540px" AutoGenerateColumns="False" CssClass="t_tablestyle" DataKeyNames="LOID" EmptyDataText="<center>***ไม่พบข้อมูล***</center>" OnRowDataBound="grvProduct_RowDataBound">
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbSelect" runat="server" CausesValidation="True" AlternateText="เลือก" ImageUrl="~/Images/icn_submit.gif" /> 
                                </ItemTemplate>
                            </asp:TemplateField> 
                            ...
                            <asp:BoundField DataField="CODE" HeaderText="รหัสสินค้า">
                                <ItemStyle Width="100px"/>
                                <HeaderStyle Width="100px"/>
                            </asp:BoundField> 
                            <asp:BoundField DataField="PDNAME" HeaderText="ชื่อสินค้า">
                            </asp:BoundField>
