<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Search_Product" %>
    ...
    <div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="545">
            ...
            <tr>
                ...
                <td align="right">
                    &nbsp;<asp:Button ID="btnOKTop" runat="server" CssClass="zButton" Text="เลือก" Width="80px" />
                    <asp:Button ID="btnCloseTop" runat="server" CssClass="zButton" Text="ปิดหน้าต่าง" Width="80px" />
                </td>
            </tr>
            <tr>
                <td height="10" width="5px">
                ...
                <td>
                    <asp:GridView ID="grvProduct" runat="server" Width="540px" AutoGenerateColumns="False" CssClass="t_tablestyle" DataKeyNames="LOID" EmptyDataText="<center>***ไม่พบข้อมูล***</center>" OnRowDataBound="grvProduct_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GNAME" HeaderText="กลุ่มสินค้า">
            ...
            <tr>
                ...
                <td height="20">
                    <asp:TextBox ID="txtProduct" runat="server" CssClass="zHidden" Width="120px"></asp:TextBox>
                    <asp:TextBox ID="txtSelectProduct" runat="server" CssClass="zHidden" Width="120px"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="5px">
                </td>
