<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="PlanSearch.aspx.cs" Inherits="Transaction_PlanSearch" Title="แผนการจำหน่ายสินค้า" %>
            ...
            <td>
                <asp:GridView ID="grvPlan" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="LOID" DataNavigateUrlFormatString="PlanOrder.aspx?loid={0}"
