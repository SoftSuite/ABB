<%@ Page Language="C#"  MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="ProductOrder.aspx.cs" Inherits="Transaction_ProductOrder"  Title="บันทึกสั่งผลิตสินค้า" %>
        ...
        <tr>
            <td class="toolbarplace" colspan="3">
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="true" BtnCancelShow="true"
                    ...
                    BtnReturnShow="false" BtnSaveShow="true" BtnSubmitShow="true" NameBtnSubmit="ส่งฝ่ายผลิต"
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:GridView ID="grvItem" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle" ShowFooter="True"
                                Width="600px" DataKeyNames="LOID" EmptyDataText="<center>***ไม่พบข้อมูล***</center>" DataSourceID="ItemDataSource" OnRowCommand="grvItem_RowCommand" OnRowDataBound="grvItem_RowDataBound" OnRowUpdated="grvItem_RowUpdated" OnRowDeleted="grvItem_RowDeleted" OnRowUpdating="grvItem_RowUpdating">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="วันที่ต้องการ">
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="grvItemNew" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="วันที่ต้องการ" InsertVisible="False">
                                        <ItemTemplate>
                                            <uc2:DatePickerControl ID="txtNewDate" runat="server" />
                                        </ItemTemplate>
                                        <HeaderStyle Width="150px" />
