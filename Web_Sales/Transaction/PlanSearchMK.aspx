<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="PlanSearchMK.aspx.cs" Inherits="Transaction_PlanSearchMK" Title="แผนการตลาด" %>
                ...
                <asp:GridView ID="grvPlan" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:ImageButton ID="btnPrint" runat="server" CausesValidation="False" CommandName="print" AlternateText="พิมพ์ประมาณการขาย"
                                    ImageUrl="~/Images/icn_print.gif"/>
                                    <asp:ImageButton ID="btnPrint2" runat="server" CausesValidation="False" CommandName="print" AlternateText="พิมพ์สรุปการขาย"
                                    ImageUrl="~/Images/icn_print.gif"/>
                                    <asp:ImageButton ID="btnPrint3" runat="server" CausesValidation="False" CommandName="print" AlternateText="พิมพ์ผลต่างจากการประมาณ"
                                    ImageUrl="~/Images/icn_print.gif"/>
