...
namespace ABB.DAL
{
    public class DiscountStepDAL
    {
        ...
        private string tableName = "DISCOUNTSTEP";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,MEMBERTYPE,LOWERPRICE,DISCOUNT)VALUES(";
                ...
                sqlz += "  " + _LOWERPRICE.ToString() + ",";// LOWERPRICE";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " LOWERPRICE  = " + _LOWERPRICE.ToString() + ", ";
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["LOWERPRICE"])) _LOWERPRICE = Convert.ToDouble(zRdr["LOWERPRICE"]);
        ...
        /// <param name="zTrans">Transaction, set to null if no transaction provided</param>
        /// <returns></returns>
        public bool DeleteDataByMemberType(double memberType, OracleTransaction zTrans)
        {
            return doDelete("MEMBERTYPE = " + memberType.ToString() + " ", zTrans);
        }
