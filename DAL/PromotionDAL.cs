...
namespace ABB.DAL
{
    public class PromotionDAL
    {
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CODE,CREATEBY,CREATEON,UPDATEBY,UPDATEON,NAME,EFDATE,EPDATE,DISCOUNT,WAREHOUSE,ZONE, LOWERPRICE)VALUES(";
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["UPDATEON"])) _UPDATEON = OracleDB.DBDate(zRdr["UPDATEON"].ToString());
