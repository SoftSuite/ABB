...
namespace ABB.DAL
{
    public class ProductGroupDAL
    {
        ...
        private string tableName = "PRODUCTGROUP";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID, CODE, NAME, PRODUCTTYPE, ACTIVE, CREATEBY, CREATEON) VALUES (";
                sqlz += "  " + _LOID.ToString() + ",";
                sqlz += " '" + OracleDB.QRText(_CODE) + "',";
                sqlz += " '" + OracleDB.QRText(_NAME) + "',";
                sqlz += " " + _PRODUCTTYPE.ToString() + ",";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " PRODUCTTYPE  = " + PRODUCTTYPE.ToString() + ", ";
        ...
        /// <param name="zTrans">Transaction, set to null if no transaction provided</param>
        /// <returns></returns>
        public bool GetDataByCode(string code, double notLOID, OracleTransaction zTrans)
        {
            return doGetdata(" UPPER(CODE) = '" + code.Trim().ToUpper() + "' AND LOID <> " + notLOID.ToString() + " ", zTrans);
        }
        ...
        /// <param name="zTrans">Transaction, set to null if no transaction provided</param>
        /// <returns></returns>
        public bool GetDataByName(string name, double productType, double notLOID, OracleTransaction zTrans)
        {
            return doGetdata(" UPPER(NAME) = '" + name.Trim().ToUpper() + "' AND PRODUCTTYPE = " + productType + " AND LOID <> " + notLOID.ToString() + " ", zTrans);
        }
