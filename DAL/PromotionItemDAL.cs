...
namespace ABB.DAL
{
    public class PromotionItemDAL
    {
        ...
        private string tableName = "PROMOTIONITEM";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,PROMOTION,CREATEBY,CREATEON,UPDATEBY,UPDATEON,PRODUCT,PRICENEW,PRICEOLD)VALUES(";
                sqlz += "  " + _LOID.ToString() + ",";// LOID";
                sqlz += "  " + _PROMOTION.ToString() + ",";// PROMOTION";
                ...
                sqlz += "  " + _PRICENEW.ToString() + ",";// PRICENEW";
                sqlz += "  " + _PRICEOLD.ToString() + "";// PRICEOLD";
                sqlz += " ) ";
                return sqlz;
            }
        }
        ...
        /// <param name="zTrans">Transaction, set to null if no transaction provided</param>
        /// <returns></returns>
        public bool DeleteDataByPromotion(double promotion, OracleTransaction zTrans)
        {
            return doDelete(" PROMOTION = " + promotion.ToString() + " ", zTrans);
        }
