...
namespace ABB.DAL
{
    public class StockCheckItemDAL
    {
        ...
        private string tableName = "STOCKCHECKITEM";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,STOCKCHECK,PRODUCT,LOTNO,COUNTQTY,LOCATION)VALUES(";
                ...
                sqlz += "  " + _STOCKCHECK.ToString() + ",";// STOCKCHECK";
                sqlz += "  " + _PRODUCT.ToString() + ",";// PRODUCT";
                sqlz += " '" + OracleDB.QRText(_LOTNO) + "',";// LOTNO";
                sqlz += "  " + _COUNTQTY.ToString() + ",";// COUNTQTY";
                sqlz += "  " + _LOCATION.ToString() + "";// LOCATION";
                sqlz += " ) ";
                return sqlz;
            }
        }
        private string sql_update
        {
            get
            {
                ...
                sqlz += " STOCKCHECK  = " + _STOCKCHECK.ToString() + ", ";
                sqlz += " PRODUCT  = " + _PRODUCT.ToString() + ", ";
                sqlz += " LOTNO  = '" + OracleDB.QRText(_LOTNO) + "', ";
                sqlz += " COUNTQTY  = " + _COUNTQTY.ToString() + ", ";
                sqlz += " LOCATION  = " + _LOCATION.ToString() + " ";
                sqlz += "  ";
                return sqlz;
            }
        }
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["STOCKCHECK"])) _STOCKCHECK = Convert.ToDouble(zRdr["STOCKCHECK"]);
                        ...
                        if (!Convert.IsDBNull(zRdr["LOCATION"])) _LOCATION = Convert.ToDouble(zRdr["LOCATION"]);
                    }
                    else
                    {
                        ret = false;
        ...
        public bool DeleteDataByStockCheck(double stockCheck, OracleTransaction zTrans)
        {
            return doDelete("STOCKCHECK = " + stockCheck.ToString() + " ", zTrans);
        }
    }
}