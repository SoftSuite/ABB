...
namespace ABB.DAL
{
    public class StockCheckDAL
    {
        ...
        private string tableName = "STOCKCHECK";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,BATCHNO,CHECKDATE,WAREHOUSE,STATUS)VALUES(";
                ...
                sqlz += " '" + OracleDB.QRText(_BATCHNO) + "',";// BATCHNO";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " BATCHNO  = '" + OracleDB.QRText(_BATCHNO) + "', ";
