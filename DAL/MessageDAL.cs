...
namespace ABB.DAL
{
    public class MessageDAL
    {
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,MESSAGE,EFDATE,EPDATE)VALUES(";
                ...
                sqlz += " '" + OracleDB.QRText(_MESSAGE) + "',";// MESSAGE";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " MESSAGE  = '" + OracleDB.QRText(_MESSAGE) + "', ";
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["MESSAGE"])) _MESSAGE = zRdr["MESSAGE"].ToString();
