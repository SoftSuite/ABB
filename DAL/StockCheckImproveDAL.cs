...
namespace ABB.DAL
{
    public class StockCheckImproveDAL
    {
        ...
        private string tableName = "STOCKCHECKIMPROVE";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,STOCKCHECK,PRODUCTSTOCK,SYSQTY,IMPROVEQTY,REASON)VALUES(";
                ...
                sqlz += "  " + _SYSQTY.ToString() + ",";// SYSQTY";
                sqlz += "  " + _IMPROVEQTY.ToString() + ",";// IMPROVEQTY";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " SYSQTY  = " + _SYSQTY.ToString() + ", ";
                sqlz += " IMPROVEQTY  = " + _IMPROVEQTY.ToString() + ", ";
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["SYSQTY"])) _SYSQTY = Convert.ToDouble(zRdr["SYSQTY"]);
