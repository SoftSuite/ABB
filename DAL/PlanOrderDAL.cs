...
namespace ABB.DAL
{
    public class PlanOrderDAL
    {
        ...
        private string tableName = "PLANORDER";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (M11,M12,PRODUCTMASTER,LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,PLAN,PRODUCT,UNIT,MONTH,STATUS,M1,M2,M3,M4,M5,M6,M7,M8,M9,M10)VALUES(";
