...
namespace ABB.DAL
{
    public class MemberTypeDAL
    {
        ...
        private string tableName = "MEMBERTYPE";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID, CODE, NAME, DESCRIPTION, DISCOUNT, LOWERPRICE, ACTIVE, CREATEBY, CREATEON) VALUES (";
                sqlz += "  " + _LOID.ToString() + ",";
                sqlz += " '" + OracleDB.QRText(_CODE) + "',";
                sqlz += " '" + OracleDB.QRText(_NAME) + "',";
                sqlz += " '" + OracleDB.QRText(_DESCRIPTION) + "',";
                sqlz += " '" + OracleDB.QRText(_DISCOUNT.ToString()) + "',";
                sqlz += " '" + OracleDB.QRText(_LOWERPRICE.ToString()) + "',";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " DISCOUNT  = '" + OracleDB.QRText(_DISCOUNT.ToString()) + "', ";
                sqlz += " LOWERPRICE  = '" + OracleDB.QRText(_LOWERPRICE.ToString()) + "', ";
