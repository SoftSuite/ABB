...
namespace ABB.DAL
{
    public class SysConfigDAL
    {
        ...
        private string tableName = "SYSCONFIG";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CONFIGNAME,CONFIGVALUE,DESCRIPTION)VALUES(";
                sqlz += "  " + _LOID.ToString() + ",";// LOID";
                sqlz += " '" + OracleDB.QRText(_CONFIGNAME) + "',";// CONFIGNAME";
                sqlz += " '" + OracleDB.QRText(_CONFIGVALUE) + "',";// CONFIGVALUE";
        ...
        private string sql_update
        {
            get
            {
                ...
                sqlz += " CONFIGNAME  = '" + OracleDB.QRText(_CONFIGNAME) + "', ";
                sqlz += " CONFIGVALUE  = '" + OracleDB.QRText(_CONFIGVALUE) + "', ";
        ...
        /// <param name="zTrans">Transaction, set to null if no transaction provided</param>
        /// <returns></returns>
        public bool GetDataByName(string ConfigName, OracleTransaction zTrans)
        {
            return doGetdata(" CONFIGNAME = '" + ConfigName + "' ", zTrans);
        }
