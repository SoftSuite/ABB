...
namespace ABB.DAL
{
    public class PlanProduceDAL
    {
        ...
        private string tableName = "PLANPRODUCE";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (PRODUCTMASTER,DAY28,DAY29,DAY30,DAY31,DAY17,DAY18,DAY19,DAY20,DAY21,DAY22,DAY23,DAY24,DAY25,DAY26,DAY27,LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,PLAN,PRODUCT,UNIT,MONTH,STATUS,DAY1,DAY2,DAY3,DAY4,DAY5,DAY6,DAY7,DAY8,DAY9,DAY10,DAY11,DAY12,DAY13,DAY14,DAY15,DAY16)VALUES(";
        ...
        public bool GetData(double plan, int month, double product, string status, OracleTransaction zTrans)
        {
            return doGetdata(" PLAN = " + plan.ToString() + " AND PRODUCT = " + product.ToString() + " AND MONTH = " + month.ToString() + " AND STATUS = '" + status + "' ", zTrans);
        }
