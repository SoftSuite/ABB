...
namespace ABB.DAL
{
    public class OfficerPositionDAL
    {
        ...
        private string tableName = "OFFICERPOSITION";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,OFFICER,POSITION)VALUES(";
                ...
                sqlz += "  " + _POSITION.ToString() + "";// POSITION";
                sqlz += " ) ";
                return sqlz;
            }
        }
        private string sql_update
        {
            get
            {
                ...
                sqlz += " POSITION  = " + _POSITION.ToString() + " ";
                sqlz += "  ";
                return sqlz;
            }
        }
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    if (zRdr.Read())
                    {
                        ...
                        if (!Convert.IsDBNull(zRdr["POSITION"])) _POSITION = Convert.ToDouble(zRdr["POSITION"]);
                    }
                    else
                    {
                        ret = false;
        ...
        public bool DeleteDataByOfficer(double Officer, OracleTransaction zTrans)
        {
            return doDelete("OFFCIER = " + Officer.ToString() + " ", zTrans);
        }
    }
}