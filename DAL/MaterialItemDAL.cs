...
namespace ABB.DAL
{
    public class MaterialItemDAL
    {
        ...
        private string tableName = "MATERIALITEM";
        ...
        private string sql_insert
        {
            get
            {
                string sqlz = "INSERT INTO " + tableName + " (WASTEQTYMAN,RETURNQTY,CHANGEQTY,UNIT,ACTIVE,REMARK,YIELDMAT,YIELDMAM,PGROUP,LOID,CREATEBY,CREATEON,UPDATEBY,UPDATEON,PDPRODUCT,PRODUCT,ALLQTY,USEQTY,WASTEQTYMAT)VALUES(";
                sqlz += "  " + _WASTEQTYMAN.ToString() + ",";// WASTEQTYMAN";
                ...
                sqlz += " '" + OracleDB.QRText(_PGROUP) + "',";// PGROUP";
                ...
                sqlz += "  " + _PDPRODUCT.ToString() + ",";// PDPRODUCT";
                sqlz += "  " + _PRODUCT.ToString() + ",";// PRODUCT";
                sqlz += "  " + _ALLQTY.ToString() + ",";// ALLQTY";
        ...
        private bool doGetdata(string whText, OracleTransaction zTrans)
        {
            ...
            if (whText.Trim() != "")
            {
                ...
                try
                {
                    ...
                    {
                        _OnDB = true;
                        if (!Convert.IsDBNull(zRdr["WASTEQTYMAN"])) _WASTEQTYMAN = Convert.ToDouble(zRdr["WASTEQTYMAN"]);
                        ...
                        if (!Convert.IsDBNull(zRdr["PGROUP"])) _PGROUP = zRdr["PGROUP"].ToString();
                        ...
                        if (!Convert.IsDBNull(zRdr["PDPRODUCT"])) _PDPRODUCT = Convert.ToDouble(zRdr["PDPRODUCT"]);
                        if (!Convert.IsDBNull(zRdr["PRODUCT"])) _PRODUCT = Convert.ToDouble(zRdr["PRODUCT"]);
                        if (!Convert.IsDBNull(zRdr["ALLQTY"])) _ALLQTY = Convert.ToDouble(zRdr["ALLQTY"]);
