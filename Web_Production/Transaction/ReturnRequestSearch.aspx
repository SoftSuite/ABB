<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="ReturnRequestSearch.aspx.cs" Inherits="Transaction_ReturnRequestSearch" Title="ใบแจ้งคืนวัตถุดิบและบรรจุภัณฑ์" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="800px" class="searchTable">
                    ...
                    <tr height="25px">
                        ...
                        <td style="width: 161px">
                            <uc2:DatePickerControl ID="ctlReqDateFrom" runat="server" />
                        </td>
                        <td width="20px" align="center">
                            ถึง</td>
                        <td style="width: 170px"><uc2:DatePickerControl ID="ctlReqDateTo" runat="server" /></td>
                        <td></td>
                    </tr> 
                     <tr height="25px">
                        <td width="50px"></td>
                    ...
                    <tr height="25px">
                        ...
                        <td width="150px">
                            ชื่อผลิตภัณฑ์</td>
                        <td colspan="3"><asp:DropDownList ID="cmbProduct" runat="server" CssClass="zComboBox" Width="330px">
                        </asp:DropDownList></td>
                        <td></td>
                    </tr>                    
                    <tr height="25px">
                ...
                <asp:GridView ID="grvPDReserve" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="LOID" DataNavigateUrlFormatString="ReturnRequest.aspx?loid={0}"
                            DataTextField="CODE" HeaderText="เลขที่ใบแจ้งคืน" DataTextFormatString="{0}" >
                        ...
                        <asp:BoundField SortExpression="REQDATE" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="False" HeaderText = "วันที่ส่งคืน" DataField="REQDATE" >
                            <ItemStyle Width="80px" HorizontalAlign="center"/>
                            <HeaderStyle Width="80px" />  
                        </asp:BoundField> 
