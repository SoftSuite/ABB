<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="PlanProduce.aspx.cs" Inherits="Transaction_PlanProduce" Title="แผนการสั่งผลิตสินค้า/วัตถุดิบ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                &nbsp;แผนการสั่งผลิตสินค้า/วัตถุดิบ</td> 
        </tr> 
        <tr>
