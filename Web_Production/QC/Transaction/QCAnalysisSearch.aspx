<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="QCAnalysisSearch.aspx.cs" Inherits="QC_Transaction_QCAnalysisSearch" Title="รายการวิเคราะห์คุณภาพ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr height="25px">
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="700px" class="searchTable">
                    <tr>
