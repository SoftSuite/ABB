<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="NewPO.aspx.cs" Inherits="FG_Transaction_StockInPO_NewPO" Title="รับสินค้าจากผู้จำหน่าย" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainForm" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width = "100%">
        <tr>
            <td class = "subheadertext">
                &nbsp;สร้างใบตรวจรับสินค้าใหม่</td> 
        </tr> 
        <tr>
