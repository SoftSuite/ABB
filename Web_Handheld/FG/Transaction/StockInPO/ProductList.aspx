<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="FG_Transaction_StockInPO_ProductList" Title="รับสินค้าจากผู้จำหน่าย" %>
        ...
        <tr>
            <td class="toolbarplace">
                <uc1:ToolbarControl ID="ctlToolbar1" runat="server" BtnBackShow="false" BtnCancelShow="false" BtnDeleteShow="false" 
                    ...
                    BtnSubmitShow="false" BtnHelpShow="false" OnNewClick="NewClick" NameBtnNew="เพิ่มสินค้า" />
