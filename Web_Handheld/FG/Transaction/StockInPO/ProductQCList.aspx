<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="ProductQCList.aspx.cs" Inherits="FG_Transaction_StockInPO_ProductQCList" Title="รับสินค้าจากผู้จำหน่าย" %>
        ...
        <tr>
            <td class="toolbarplace">
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="false" BtnCancelShow="false" BtnDeleteShow="false" 
                    ...
                    BtnSubmitShow="true" BtnHelpShow="false" OnNewClick="NewClick" OnSubmitClick="SubmitClick" NameBtnSubmit="ยืนยัน" />
            </td> 
        </tr> 
        <tr>
            <td height="150px" valign="top">
                <asp:Panel ID="pnlData" runat="server">
                    <table border="0" cellpadding="0" cellspacing="0" width="100px">
                        <tr>
                            <td height="20px">
                                <b>เลขที่ใบตรวจรับ : </b><asp:Label ID="lblCode" runat="server" ></asp:Label>
                            </td>
                        </tr> 
                        <tr>
                            <td height="20px">
                                <b>วันที่ : </b> <asp:Label ID="lblReceiveDate" runat="server" ></asp:Label>
                            </td>
                        </tr> 
                        <tr>
                            <td height="20px">
                                <b>เลขที่ใบแจ้ง : </b> <asp:Label ID="lblQCCode" runat="server" ></asp:Label>
                            </td>
                        </tr> 
                        <tr>
                            <td>
                                <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NAME" HeaderText="สินค้า">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="QTY" HeaderText="จำนวนรับ" DataFormatString="{0:#,##0}" HtmlEncode="false">
