<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="FG_Transaction_StockInPD_ProductList" Title="รับสินค้าจากฝ่ายผลิต" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainForm" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width = "100%">
        ...
        <tr>
            <td height="20">
                <b>&nbsp;เลขที่ใบนำส่ง : </b>
                <asp:Label ID="txtCode" runat="server" ></asp:Label></td> 
        </tr> 
        <tr>
                ...
                <asp:Panel ID="pnlData" runat="server">
                    <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LOTNO" HeaderText="เลขที่การผลิต">
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
