<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="FG_Transaction_StockInPD_AddProduct" Title="รับสินค้าจากฝ่ายผลิต" %>
