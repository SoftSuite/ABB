<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="WH_Transaction_StockCheck_ProductList" Title="ตรวจนับวัตถุดิบ" %>
                                        ...
                                        <td>
                                            <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="productNAME" HeaderText="วัตถุดิบ">
                                                    </asp:BoundField>
