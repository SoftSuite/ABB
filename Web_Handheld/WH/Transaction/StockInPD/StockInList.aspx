<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="StockInList.aspx.cs" Inherits="WH_Transaction_StockInPD_StockInList" Title="รับวัตถุดิบจากฝ่ายผลิต" %>
                ...
                <asp:Panel ID="pnlData" runat="server">
                    <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="APPROVEDATE" DataFormatString="{0 : dd/MM/yyyy}" HtmlEncode="False" HeaderText="วันที่">
                            ...
                            <td class="messageLayer" valign="bottom">
                                <table border="0" cellpadding="0" cellspacing="0" width="220px">
                                    ...
                                    <tr height="18">
                                        ...
                                        <td colspan="2">
                                            <b>สร้างใบนำส่งวัตถุดิบเข้าคลังใหม่หรือไม่ ?</b>
                                        </td> 
                                    </tr> 
                                    <tr height="3">
                                        <td colspan="2"></td> 
