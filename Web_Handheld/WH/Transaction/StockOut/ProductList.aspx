<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="WH_Transaction_StockOut_ProductList" Title="เบิกวัตถุดิบ" %>
            ...
            <td height="150" valign="top">
                <asp:Panel ID="pnlData" runat="server">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr height="20px">
                            <td>
                                &nbsp;<b>เลขที่ใบเบิก : </b><asp:Label ID="lblCode" runat="server" ></asp:Label>
                            </td>
                        </tr> 
                        <tr height="20px">
                            <td>
                                &nbsp;<b>เลขที่ขอเบิก : </b><asp:Label ID="lblReqCode" runat="server"></asp:Label>
                            </td>
                        </tr> 
                        <tr height="20px">
                            <td>
                                &nbsp;<b>ประเภท : </b><asp:Label ID="lblDocName" runat="server"></asp:Label>
                            </td>
                        </tr> 
                        <tr height="20">
                            <td>
                                &nbsp;<b>เลขที่การผลิต : </b><asp:Label ID="lblOrderLotNo" runat="server"></asp:Label> 
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="QTY" HeaderText="จำนวน" DataFormatString="{0:#,##0}" HtmlEncode="false">
