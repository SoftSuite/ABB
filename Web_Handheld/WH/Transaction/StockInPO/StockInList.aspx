<%@ Page Language="C#" MasterPageFile="~/Template/MasterBody.master" AutoEventWireup="true" CodeFile="StockInList.aspx.cs" Inherits="WH_Transaction_StockInPO_StockInList" Title="รับวัตถุดิบจากผู้จำหน่าย" %>
