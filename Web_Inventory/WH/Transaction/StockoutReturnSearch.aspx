<%@ Page Language="C#"  MasterPageFile="~/Template/Page1.master"  AutoEventWireup="true" CodeFile="StockoutReturnSearch.aspx.cs" Inherits="WH_Transaction_StockoutReturnSearch" Title="ใบแจ้งส่งคืนวัตถุดิบ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="headtext">
                &nbsp;ใบแจ้งส่งคืนวัตถุดิบ</td> 
        </tr> 
        <tr>
            <td class="toolbarplace">
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="false" BtnCancelShow="false"
                    BtnDeleteShow="true" BtnEditShow="false" BtnNewShow="true" BtnPrintShow="false"
                    BtnReturnShow="false" BtnSaveShow="false" BtnSubmitShow="true" NameBtnSubmit="ส่งให้จัดซื้อ"
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="800px" class="searchTable">
                    ...
                    <tr height="25px">
                        ...
                        <td width="150px">
                            ผู้จำหน่าย</td>
                        <td colspan="3"><asp:DropDownList ID="cmbSupplier" runat="server" CssClass="zComboBox" Width="321px">
                        </asp:DropDownList></td>
                        <td></td>
                    </tr> 
                    <tr height="25px">
            ...
            <td>
                <asp:GridView ID="grvRequisition" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="LOID" DataNavigateUrlFormatString="StockoutReturn.aspx?loid={0}"
                        ...
                        <asp:BoundField SortExpression="REASON" HeaderText = "สาเหตุการส่งคืน" DataField="REASON">
                            <ItemStyle Width="200px"/>
                            <HeaderStyle Width="200px" />  
                        </asp:BoundField> 
                        <asp:BoundField SortExpression="SUPPLIERNAME" HeaderText = "ลูกค้า" DataField="SUPPLIERNAME">
