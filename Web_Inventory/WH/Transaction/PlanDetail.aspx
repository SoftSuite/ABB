<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanDetail.aspx.cs" Inherits="WH_Transaction_PlanDetail" %>
...
<head id="Head1" runat="server">
    <title>รายละเอียดการสั่งวัตถุดิบ</title>
                ...
                <ContentTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr style="height:5px">
                            ...
                            <td>
                                <asp:GridView ID="grvMaterial" runat="server" CssClass="t_tablestyle" EmptyDataText=""  AutoGenerateColumns="False" Width="500px">
                                    <Columns>
                                       <asp:BoundField DataField="RANK" HeaderText="ลำดับ" >
                                            <ItemStyle Width="50px" HorizontalAlign="center" />
                                            <HeaderStyle Width="50px"/>
                                        </asp:BoundField>
                                       <asp:BoundField DataField="PRODUCTNAME" HeaderText="สินค้าที่ใช้วัตถุดิบนี้" >
                                        </asp:BoundField>
