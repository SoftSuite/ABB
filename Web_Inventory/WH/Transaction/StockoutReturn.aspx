<%@ Page Language="C#"  MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="StockoutReturn.aspx.cs" Inherits="WH_Transaction_StockoutReturn" Title="ใบแจ้งส่งคืนวัตถุดิบ" %>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="600px" class="zCombobox">
                                ...
                                <tr height="25px">
                                    ...
                                    <td style="width: 115px" valign="top">
                                        สาเหตุการส่งคืน</td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtReason" runat="server" Height="50px" TextMode="MultiLine" Width="315px" CssClass="zTextbox" ></asp:TextBox>
