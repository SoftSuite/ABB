<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="ProductBarcode.aspx.cs" Inherits="WH_Master_ProductBarcode" Title="ข้อมูลวัตถุดิบ - หน่วยย่อย" %>
        ...
        <tr class = "toolbarplace">
            <td>
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="true" BtnCancelShow="false"
                    ...
                    BtnReturnShow="true" BtnSaveShow="true" BtnSubmitShow="false" NameBtnReturn="กลับหน้าวัตถุดิบหลัก"
         ...
         <tr>
            <td>
                <asp:GridView ID="grvItem" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle" ShowFooter="True"
                    Width="615px" DataKeyNames="LOID" EmptyDataText="<center>***ไม่พบข้อมูล***</center>" DataSourceID="ItemDataSource" 
...
<ItemTemplate>
<asp:ImageButton id="imbEdit" runat="server" ImageUrl="~/Images/icn_edit.gif" AlternateText="แก้ไข" CommandName="Edit" CausesValidation="False" __designer:wfdid="w1"></asp:ImageButton>&nbsp; 
</ItemTemplate>

<FooterStyle HorizontalAlign="Center" Width="50px"></FooterStyle>
...
<asp:TemplateField HeaderText="ชื่อย่อ"><EditItemTemplate>
                                <asp:TextBox ID="txtAbbname" runat="server" CssClass="zTextbox" Width="50px" MaxLength="20" Text='<%# Bind("ABBNAME") %>'></asp:TextBox>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:TextBox ID="txtNewAbbname" runat="server" CssClass="zTextbox" Width="50px" MaxLength="20"></asp:TextBox>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:Label ID="txtAbbnameView" runat="server" Width="45px" Text='<%# Bind("ABBNAME") %>'></asp:Label>
...
<asp:TemplateField HeaderText="จำนวน"><EditItemTemplate>
                                <asp:TextBox ID="txtMultiply" runat="server" CssClass="zTextboxR" Width="50px" Text='<%# Bind("MULTIPLY") %>'></asp:TextBox>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:TextBox ID="txtNewMultiply" runat="server" CssClass="zTextboxR" Width="50px"></asp:TextBox>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:Label ID="txtMultiplyView" runat="server" Width="45px" Text='<%# Bind("MULTIPLY") %>'></asp:Label>
...
<asp:TemplateField HeaderText="หน่วย"><EditItemTemplate>
                                <asp:DropDownList ID="cmbUnit" runat="server" CssClass="zCombobox" Enabled="true" Width="95px"></asp:DropDownList>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:DropDownList ID="cmbNewUnit" runat="server" CssClass="zCombobox" Enabled="true" Width="95px"></asp:DropDownList>
...
<ItemTemplate>
                                <asp:Label ID="txtCostView" runat="server" Width="50px" Text='<%# Bind("COST") %>'></asp:Label>
...
<ItemTemplate>
                                <asp:Label ID="txtPriceView" runat="server" Width="50px" Text='<%# Bind("PRICE") %>'></asp:Label>
...
<asp:TemplateField HeaderText="ราคากลาง"><EditItemTemplate>
                                <asp:TextBox ID="txtStdPrice" runat="server" CssClass="zTextboxR" Width="50px" Text='<%# Bind("STDPRICE") %>'></asp:TextBox>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:TextBox ID="txtNewStdPrice" runat="server" CssClass="zTextboxR" Width="50px" Text="0"></asp:TextBox>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:Label ID="txtStdPriceView" runat="server" Width="50px" Text='<%# Bind("STDPRICE") %>'></asp:Label>
...
<asp:TemplateField HeaderText="หน่วยปริมาณ"><EditItemTemplate>
                                <asp:DropDownList ID="cmbUnitPack" runat="server" CssClass="zCombobox" Enabled="true" Width="95px"></asp:DropDownList>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:DropDownList ID="cmbNewUnitPack" runat="server" CssClass="zCombobox" Enabled="true" Width="95px"></asp:DropDownList>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:DropDownList ID="cmbUnitPackView" runat="server" CssClass="zCombobox" Enabled="false" Width="95px"></asp:DropDownList>
...
<asp:TemplateField HeaderText="ใช้งาน"><EditItemTemplate>
                                <asp:CheckBox ID="chkIsActive" runat="server" Enabled="true" Width="50px"></asp:CheckBox>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:CheckBox ID="chkNewIsActive" runat="server" Enabled="false" Width="50px"></asp:CheckBox>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:CheckBox ID="chkIsActiveView" runat="server" Enabled="false" Width="50px" ></asp:CheckBox>
...
<asp:TemplateField HeaderText="เริ่มต้น"><EditItemTemplate>
                                <asp:CheckBox ID="chkIsDefault" runat="server" Enabled="false" Width="50px"></asp:CheckBox>
                            
</EditItemTemplate>
<FooterTemplate>
                                <asp:CheckBox ID="chkNewIsDefault" runat="server" Enabled="false" Width="50px"></asp:CheckBox>
                            
</FooterTemplate>
<ItemTemplate>
                                <asp:CheckBox ID="chkIsDefaultView" runat="server" Enabled="false" Width="50px" ></asp:CheckBox>
