<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExpireControl.ascx.cs" Inherits="WH_ToDoList_Controls_ExpireControl" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="grvRequisition" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                EmptyDataText="<center>***ไม่พบข้อมูล***</center>" Width="800px" OnRowDataBound="grvRequisition_RowDataBound" OnRowCommand="grvRequisition_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BARCODE" HeaderText="รหัสวัตุดิบ" SortExpression="BARCODE">
                        <ItemStyle Width="100px" />
                        <HeaderStyle Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="PRODUCTNAME" HeaderText="ชื่อวัตถุดิบ" SortExpression="PRODUCTNAME">
