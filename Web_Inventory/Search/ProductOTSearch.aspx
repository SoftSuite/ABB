<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductOTSearch.aspx.cs" Inherits="Search_ProductWHSearch" %>
...
<head id="Head1" runat="server">
    <title>ค้นหารายการวัตถุดิบ</title>
  ...
  <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:GridView ID="grvReserve" runat="server" Width="540px" AutoGenerateColumns="False" CssClass="t_tablestyle" DataKeyNames="LOID,PDLOID" EmptyDataText="<center>***ไม่พบข้อมูล***</center>" OnRowDataBound="grvReserve_RowDataBound">
                        ...
                        <asp:BoundField SortExpression="BARCODE" HeaderText = "บาร์โค้ด" DataField="BARCODE">
                         ...
                         <asp:BoundField SortExpression="PDNAME" HeaderText = "ชื่อวัตถุดิบ" DataField="PDNAME">
                            <ItemStyle Width="140px"/>
                            <HeaderStyle Width="140px" />  
                        </asp:BoundField>  
                        ...
                        <asp:BoundField SortExpression="QTY" HeaderText = "จำนวนสั่งซื้อ" DataField="QTY">
                            <ItemStyle Width="100px"/>
                            <HeaderStyle Width="100px" />  
                        </asp:BoundField>
                        <asp:BoundField SortExpression="REMAIN" HeaderText = "จำนวนค้างรับ" DataField="REMAIN">
                            <ItemStyle Width="100px"/>
                            <HeaderStyle Width="100px" />  
                        </asp:BoundField>
                        ...
                        <asp:BoundField SortExpression="SUPPLIER" HeaderText = "ผู้ผลิต" DataField="SUPPLIER">
                            <ItemStyle Width="100px"/>
                            <HeaderStyle Width="100px" />  
                        </asp:BoundField>
                        </Columns>
