<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="Plan.aspx.cs" Inherits="FG_Transaction_Plan" Title="แผนการสั่งสินค้า" %>
        ...
        <tr>
            <td class="toolbarplace">
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="true" BtnCancelShow="false"
                    ...
                    OnBackClick="BackClick" OnCancelClick="CancelClick" OnSubmitClick="SubmitClick" OnPrintClick = "PrintClick" NameBtnCancel="ยกเลิกแผน" />
