<%@ Page Language="C#" MasterPageFile="~/Template/Page1.master" AutoEventWireup="true" CodeFile="StockInSupplier.aspx.cs" Inherits="FG_Transaction_StockInSupplier" Title="ตรวจรับผลิตภัณฑ์สำเร็จรูป" %>
        ...
        <tr>
            <td class="toolbarplace">
                <uc1:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="true" BtnCancelShow="false"
                    BtnDeleteShow="false" BtnEditShow="false" BtnNewShow="false" BtnPrintShow="false" NameBtnPrint="พิมพ์ใบแจ้ง QC"
                    BtnReturnShow="false" BtnSaveShow="true" BtnSubmitShow="true" NameBtnSubmit="ส่งตรวจ QC"
                    ...
                    OnBackClick="BackClick" OnCancelClick="CancelClick" OnSaveClick="SaveClick" OnSubmitClick="SubmitFNClick" />        
                     <uc1:ToolbarControl ID="ctlToolbar3" runat="server" BtnBackShow="false" BtnCancelShow="false"
                    BtnDeleteShow="false" BtnEditShow="false" BtnNewShow="false" BtnPrintShow="true" NameBtnSubmit="ยืนยันรับเข้าคลัง"
                    BtnReturnShow="false" BtnSaveShow="false" BtnSubmitShow="false" NameBtnPrint="พิมพ์ใบตรวจรับเบื้องต้น"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="320px">
                                ...
                                <tr height="25px">
                                    ...
                                    <td style="width: 120px; height: 4px;">
                                        วันที่ตรวจรับ</td>
                                    <td style="width: 132px; height: 4px;"><uc2:DatePickerControl ID="ctlReceiveDate" runat="server" Enabled="false" /></td>
                                    <td style="width: 5px; height: 4px;"></td>
                                </tr> 
                                <tr height="25px">
                                    <td style="width: 5px"></td>
                                    <td style="width:120pxpx">
                                        เลขที่ใบแจ้ง QC</td>
                                    <td style="width: 132px">
                                        <asp:TextBox ID="txtQCCode" runat="server" CssClass="zTextbox-View" ReadOnly="True"
                                            Width="110px"></asp:TextBox></td>
                                    <td style="width: 5px;"></td>
                                </tr>
                                				<tr height="25px">
                    ...
                    <tr>
					    ...
					    <asp:TextBox ID="txtPrice" runat="server" CssClass="zHidden" Width="60px" ></asp:TextBox>
					     <asp:ImageButton ID="btnNewSearch" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/view.gif" OnClick="btnNewSearchItem_Click"  />
                                    ...
                                    <asp:TemplateField HeaderText="จำนวนส่งตรวจ QC">
                                        <ItemTemplate>
                                            <asp:Label ID="txtQCQtyView" runat="server" Width="50px" Text='<%# Bind("QCQTY") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtQCQty" runat="server" CssClass="zTextboxR" Width="50px" Text='<%# Bind("QCQTY") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewQCQty" runat="server" CssClass="zTextboxR" Width="50px" Text="0"></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle Width="55px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="หน่วย">
                                        ...
                                        <asp:TemplateField HeaderText="ผลการตรวจวิเคราะห์">
                                        <ItemTemplate>
                                            <asp:Label ID="txtResultView" runat="server" Width="80px" Text='<%# Bind("QCRESULT") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtResult" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="80px" Text='<%# Bind("QCRESULT") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewResult" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="80px" ></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle Width="80px" />
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField HeaderText="เหตุผล QC">
                                        <ItemTemplate>
                                            <asp:Label ID="txtQCRemarkView" runat="server" Width="90px" Text='<%# Bind("QCREMARK") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtQCRemark" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="90px" Text='<%# Bind("QCREMARK") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewQCRemark" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="90px" ></asp:TextBox>
                                        </FooterTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
					    ...
					    <asp:TextBox ID="txtPrice" runat="server" CssClass="zHidden" Width="75px" ></asp:TextBox>
					     <asp:ImageButton ID="btnNewSearch" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/view.gif" OnClick="btnNewSearch_Click" />
                                    ...
                                    <asp:TemplateField HeaderText="จำนวนส่งตรวจ QC">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNewQCQty" runat="server" CssClass="zTextboxR" Width="50px"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="55px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="ผลการตรวจวิเคราะห์" InsertVisible="False">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNewResult" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="80px" ></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="80px" />
                                    ...
                                    <asp:TemplateField HeaderText="เหตุผล QC" InsertVisible="False">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNewQCRemark" runat="server" CssClass="zTextboxR-View" ReadOnly="true" Width="90px" ></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="90px" />
