<%@ Page Language="C#"  MasterPageFile="~/Template/Page1.master"  AutoEventWireup="true" CodeFile="StockoutReturnSearch.aspx.cs" Inherits="FG_Transaction_StockoutReturnSearch" Title="ใบแจ้งส่งคืนสินค้า" %>
            ...
            <td>
                <asp:GridView ID="grvRequisition" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField SortExpression="TOTAL" HeaderText = "ยอดสุทธิ" DataField="TOTAL">
