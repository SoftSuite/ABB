<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockInControl.ascx.cs" Inherits="FG_ToDoList_Controls_StockInControl" %>
    ...
    <tr>
        <td class="toolbarplace">
            <uc2:ToolbarControl ID="ctlToolbar" runat="server" BtnBackShow="false" BtnCancelShow="false"
                ...
                BtnReturnShow="false" BtnSaveShow="false" BtnSubmitShow="false" NameBtnNew="สร้างใบรับสินค้า" OnNewClick="NewClick"/>
        </td> 
    </tr>
    <tr>
        <td>
            <asp:GridView ID="grvRequisition" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NAME" HeaderText="ชื่อสินค้า" SortExpression="NAME">
