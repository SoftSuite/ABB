<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockOutControl.ascx.cs" Inherits="FG_ToDoList_Controls_StockOutControl" %>
        ...
        <td>
            <asp:GridView ID="grvRequisition" runat="server" AutoGenerateColumns="False" CssClass="t_tablestyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="btnNew" runat="server" CausesValidation="False" CommandName="new" AlternateText="สร้างใบเบิกสินค้า" CommandArgument = ""
                    ...
                    <asp:BoundField DataField="SENDERNAME" HeaderText="ผู้เบิกสินค้า" SortExpression="SENDERNAME">
