        ...
        public bool DeleteData(ArrayList arrData)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < arrData.Count; i++)
                {
                    ...
                    else throw new ApplicationException("ไม่สามารถลบรายการเลขที่ " + DALObj.CODE + " เนื่องจากอยู่ในสถานะอนุมัติรายการแล้ว");
                }
                obj.zTrans.Commit();
                obj.CloseConnection();
            }
            ...
            try
            {
                ...
                if (DALObj.STATUS == Constz.Requisition.Status.Approved.Code)
                {
                    if (sDAL.TotalReference("REQUISITION", requisition, obj.zTrans) > 0)
                        throw new ApplicationException("ไม่สามารถยกเลิกรายการได้ เนื่องจากรายการนี้ถูกอ้างอิงในการทำรายการต่อแล้ว");
                    else
                    {
