...
{
    public class EISReportStockinMonthFlow : EISCommonFlow
    {
        private const string TableName1 = "V_REPORT_STOCKIN_MONTH";
        private const string TableName2 = "V_REPORT_STOCKIN_DAY";
