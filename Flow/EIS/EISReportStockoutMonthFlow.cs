...
{
    public class EISReportStockoutMonthFlow : EISCommonFlow
    {
        private const string TableName1 = "V_REPORT_STOCKOUT_MONTH";
        private const string TableName2 = "V_REPORT_STOCKOUT_DAY";
        ...
        public static DataTable GetMonthPublished(int yearFrom, int yearTo, int month, string warehouse, string pd_type, string pd_group, string pd_name)
        {
            ...
            //string dispName = GetYearDisplay(monthFrom, monthTo);
