...
{
    public class EISReportReturnMonthFlow : EISCommonFlow
    {
        private const string TableName1 = "V_REPORT_RETURN_MONTH";
        private const string TableName2 = "V_REPORT_RETURN_DAY";
