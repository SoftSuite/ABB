...
{
    public class EISReportSupportMonthFlow : EISCommonFlow
    {
        private const string TableName1 = "V_REPORT_SUPPORT_MONTH";
        private const string TableName2 = "V_REPORT_SUPPORT_DAY";
